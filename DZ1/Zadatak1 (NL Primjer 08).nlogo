; Izmijeniti NL Primjer 08 na način da se broj i artikli u popisu za kupovinu određuju slučajnim rasporedom kao i broj i vrste artikala raspoređenih po trgovini određuju
; slučajnim odabirom, a da se pametna kolica za kupovinu kreću prema najbližem artiklu s popisa koji već nije stavljen u kolica, a ne unaprijed utvrđenom putanjom.
...
to setup
  ...
  set shopping-list-num []
  set shopping-list n-of (random(5) + 2) colors
  foreach shopping-list
  [
    col -> if col = "green" [set shopping-list-num lput 55 shopping-list-num]
           if col = "orange" [set shopping-list-num lput 25 shopping-list-num]
           if col = "blue" [set shopping-list-num lput 105 shopping-list-num]
           if col = "red" [set shopping-list-num lput 15 shopping-list-num]
           if col = "yellow" [set shopping-list-num lput 45 shopping-list-num]
           if col = "grey" [set shopping-list-num lput 5 shopping-list-num]
           if col = "white" [set shopping-list-num lput 9.9 shopping-list-num]
  ]
  ...
  repeat 7
  [
    ask n-of ((random 5) + 3) patches ; u svakom ponavljanju min. 3 patch-a
    [
      set pcolor read-from-string (one-of colors)
    ]
  ]
...
to walk
  ...
  [
    ...
    fd 1
    set shopping-list-num remove pcolor shopping-list-num
    wait 0.5
    shop
  ]
  [
...
Nakon modifikacije svaki put nakon setup-a imamo slučajan odabir shopping-list, ali i slučajno generiranje boja u okruženju, prema prethodno definiranim bojama.
Ujedno, kretanje i uzimanje artikala prema navedenom iz shopping-list je optimizirano. 
