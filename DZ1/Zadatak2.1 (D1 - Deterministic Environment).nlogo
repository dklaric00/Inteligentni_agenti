; Izmijeniti D1 - Deterministic Environment simulaciju na način da se pametni usisavač
...
Ukoliko usisivač, prilikom kretanja, naiđe na prljavštinu očisti je (tj. ćelija se oboji crno) i ispisuje se poruka o pronađenoj prljavštini.
